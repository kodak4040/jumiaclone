...
class Seller(models.Model):
    ...
    business_type = models.CharField(max_length = 100,choices = BusinessModel,null = False,
    blank = False,help_text='Please select if you are an individual or Business Entity/Company',
    )
    phone_number = models.CharField(max_length = 20,null = False,blank = False)
...
class Product(models.Model):
    ...
    image2 = models.ImageField(upload_to = 'Product/Main-image/',null = True,blank = True)
...
class Order(models.Model):
    ...
    '''def __str__(self):
       for order_item in self.product.all():
        return str(order_item.get_seller())'''
